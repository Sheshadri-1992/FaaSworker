              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.parameterArray = new java.util.ArrayList<Argument>(_list0.size);
                  Argument _elem1;
                  for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                  {
                    _elem1 = new Argument();
                    _elem1.read(iprot);
                    struct.parameterArray.add(_elem1);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, putBlock_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.parameterArray != null) {
          oprot.writeFieldBegin(PARAMETER_ARRAY_FIELD_DESC);
          {
            ...
            for (Argument _iter3 : struct.parameterArray)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetParameterArray()) {
          {
            ...
            for (Argument _iter4 : struct.parameterArray)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.parameterArray = new java.util.ArrayList<Argument>(_list5.size);
            Argument _elem6;
            for (int _i7 = 0; _i7 < _list5.size; ++_i7)
            {
              _elem6 = new Argument();
              _elem6.read(iprot);
              struct.parameterArray.add(_elem6);
            }
          }
          struct.setParameterArrayIsSet(true);
        }
