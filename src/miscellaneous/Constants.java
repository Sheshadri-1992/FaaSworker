...
public class Constants {
	public static final String EDGE_PARAMS_DIRECTORY = "./edge_cache/";
	public static final Integer WORKER_PORT = 8000;
	...
	public static final String  GIF_CREATOR= "gif_creator";
	public static final String VIDEO_CONVERSION = "video_conversion";
